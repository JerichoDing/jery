...
const createCommands = () => {
  ...
  program
    .command('addcpn <name>')
    .description('add vue component, 例如: jery addcpn NavBar [-d src/components]')
    .action(name => addComponent(name, program.dest || 'src/components'))

  program
    .command('addpage <name>')
    .description('add vue page, 例如: jery addpage Home [-d dest]')
    .action(name => {
  ...
  program
    ...
    .description('add vue store, 例如: jery addstore favor [-d dest]')
    .action(name => {
