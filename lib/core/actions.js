...
const createProject = async (project,framework, otherArg) => {
  // 1.提示信息
  log.hint('jery helps you create your project, please wait a moment~');

  // 2.clone项目从仓库
  log.hint(`jery helps you create ${project} ${REPO.gitRepo[framework]} project, please wait a moment~`);
  // return
  await downloadRepo(REPO.gitRepo[framework], project, { clone: true });
